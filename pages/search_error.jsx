        ...
        <section className="flex items-center h-full p-16 bg-gray-900 text-gray-100">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-lg text-center">
                    ...
                    <p className="mt-4 mb-8 text-gray-400">{`can't fint the product you're looking for? Contact us through any means below`}  or <span onClick={() => { router.back() }} className='cursor-pointer text-white'>go back</span></p>
